...
class HeroPlane(pygame.sprite.Sprite):
    ...
    def __init__(self, screen):
        ...
        self.rect.topleft = [Manager.bg_size[0]/2 - 11/2, 600]
...
class Manager(object):
    ...
    def main(self):
        ...
        self.new_player()
        # 开启创建敌机的定时器
        pygame.time.set_timer(Manager.create_enemt_id, 1000)
        while True:
            # 把背景图片贴到窗口
            ...
            for event in pygame.event.get():
                ...
                if event.type == QUIT:
                    self.exit()
                elif event.type == Manager.create_enemt_id:
                    # 创建一个敌机
                    self.new_enemy()
            ...
            if self.players.sprites():
                ...
                if isover:
                    Manager.is_game_over = True  # 标识着游戏结束
